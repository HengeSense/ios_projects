...
- (UIView *)viewWithMessage {    
    ...
    TextContainerView *textView = [paragraph generatedTextViewWithFrame:CGRectMake(10, 5, MESSAGE_MAX_WIDTH, 0)];
    ...
    if(self.messageOwner == MESSAGE_OWNER_THEIRS) {
        backgroundImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, textView.frame.size.width + 14, textView.frame.size.height + 12)];
    ...
    messageView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, backgroundImage.frame.size.width, backgroundImage.frame.size.height)];
