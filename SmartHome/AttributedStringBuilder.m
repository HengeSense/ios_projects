...
- (NSMutableAttributedString *)appendStringWithString:
    ...
    /*
     CFAttributedStringSetAttribute(str, CFRangeMake(0, str.length), kCTKernAttributeName, (__bridge CFTypeRef)([NSNumber numberWithFloat:0.0]));
     CFAttributedStringSetAttribute(str, CFRangeMake(0, str.length), kCTLigatureAttributeName, (__bridge CFTypeRef)([NSNumber numberWithInt:0]));
     */
