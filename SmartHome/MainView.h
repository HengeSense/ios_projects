...
@interface MainView : NavigationView<SpeechRecognitionNotificationDelegate, DeviceCommandUpdateUnitsHandlerDelegate, DeviceCommandGetNotificationsHandlerDelegate>
